...
(function () {
  ...
  var CWR_I18N = {
    en: {
      ...
      'services.intro':        'Fixed packages for service businesses — booking, crews, payments, and admin in one place. Every build includes 1 month of the maintenance plan you pick. Add proven modules \u00e0 la carte, or go all-in with a Studio Build — the same platform we use for live field-service businesses today.',
    ...
    es: {
      ...
      'services.intro':       'Paquetes fijos para negocios de servicios \u2014 reservas, equipos, pagos y administraci\u00f3n en un solo lugar. Cada proyecto incluye 1 mes del plan de mantenimiento que elijas. Agrega m\u00f3dulos probados \u00e0 la carte, o apuesta por un Studio Build \u2014 la misma plataforma que usamos para negocios en operaci\u00f3n hoy.',
