...
(function () {
  ...
  var CWR_I18N = {
    en: {
      ...
      'services.web_note':     'Website only \u00b7 Fixed package \u00b7 ~1\u20132 weeks \u00b7 Maintenance included \u00b7 1 month only',
      'services.web_f1':       'Branded website (1\u20133 pages) \u2014 home, services, work, and contact',
      'services.web_f2':       'Quote request + booking request forms',
      'services.web_f3':       'Work gallery with customer reviews and testimonials',
      'services.web_f4':       'Live chat so customers can message you directly',
      'services.web_f5':       'Click-to-call and click-to-text on every page',
      'services.web_f6':       'Bilingual customer-facing pages (English + Spanish)',
      'services.web_f7':       'Basic SEO + analytics so you know who visits',
      'services.web_f8':       'Launch + hosting setup support',
      'services.web_f9':       'Branded Link Tree for Instagram &amp; TikTok (your one bio link)',
      'services.web_cta':      'Start at $799',
      ...
      'services.starter_f1':    'Branded website (1\u20133 pages) \u2014 customers use the site, not an app',
      'services.starter_f2':    'iOS &amp; Android app for you and the team',
      'services.starter_f3':    'Quote request + booking request forms',
      'services.starter_f4':    'Live chat so customers can message you directly',
      'services.starter_f5':    'Work gallery, reviews, and bilingual pages (English + Spanish)',
      'services.starter_f6':    'Alerts when someone inquires',
      'services.starter_f7':    'App Store &amp; Google Play setup support',
      'services.starter_f8':    'Basic SEO + analytics, launch + hosting setup',
      'services.starter_f9':    'Branded Link Tree for Instagram &amp; TikTok (your one bio link)',
      ...
      'services.growth_f1':     'Branded site: Home, Services, Work, Reviews, Contact \u2014 customers use the web',
      'services.growth_f2':     'iOS &amp; Android staff app for owner and crew (not a customer storefront app)',
      'services.growth_f3':     'Quote &amp; booking forms, live chat, bilingual English / Spanish',
      'services.growth_f4':     'Stripe checkout with tips, tax, and recurring billing',
      'services.growth_f5':     'Admin for leads, jobs, calendar, customers, and inbox',
      'services.growth_f6':     'PDF estimates &amp; invoices emailed to the customer',
      'services.growth_f7':     'Crew assignment, scheduling, and hours per job',
      'services.growth_f8':     'Before/after portfolio \u2014 crew submits, you approve, published to the site',
      'services.growth_f9':     'Push + email notifications, payment and appointment reminders',
      'services.growth_f10':    'Tap to Pay on iPhone for jobs in the field',
      'services.growth_f11':    'Launch, hosting, App Store &amp; Google Play setup',
      ...
      'services.ess_f1':        '2 hours per month \u00b7 1 work session',
      'services.ess_f2':        'We reply within 5 business days',
      'services.ess_f3':        'We look at bugs and broken flows (after Standard and Priority)',
      'services.ess_f4':        'If the site or app goes down, you\u2019ll hear from us within 1 business day (weekdays)',
      'services.ess_f5':        'App updates to Apple and Google 4 times a year, during your work session',
      'services.ess_f6':        'Content and copy updates during your work session',
      'services.ess_f7':        'New features and add-ons are quoted separately',
      'services.ess_f8':        'Hosting, updates, monitoring \u00b7 website, iPhone, and Android',
      ...
      'services.std_f1':        '6 hours per month \u00b7 2 work sessions',
      'services.std_f2':        'We reply within 3 business days',
      'services.std_f3':        'We look at bugs and broken flows — ahead of Essential',
      'services.std_f4':        'If the site or app goes down, you\u2019ll hear from us within 4 hours',
      'services.std_f5':        'Evenings and weekends included if the site or app goes down',
      'services.std_f6':        'App updates to Apple and Google every month, both stores',
      'services.std_f7':        'Monthly content updates (photos, prices, hours, copy) — separate from work sessions',
      'services.std_f8':        'One small new feature each month (uses your hours)',
      'services.std_f9':        'One smaller add-on each quarter (a new tool for one job)',
      'services.std_f10':       'One larger add-on each year (a whole new part of the product)',
      'services.std_f11':       'Hosting, updates, monitoring \u00b7 website, iPhone, and Android',
      ...
      'services.pri_f1':        '10 hours per month \u00b7 3 work sessions',
      'services.pri_f2':        'We reply within 1 business day',
      'services.pri_f3':        'We look at bugs and broken flows — ahead of Standard',
      'services.pri_f4':        'If the site or app goes down, you\u2019ll hear from us within 2 hours',
      'services.pri_f5':        'Evenings and weekends included if the site or app goes down — ahead of Standard',
      'services.pri_f6':        'App updates to Apple and Google as often as you need, both stores',
      'services.pri_f7':        'Weekly content updates (photos, prices, hours, copy) — separate from work sessions',
      'services.pri_f8':        'Small new features in your hours, as they fit',
      'services.pri_f9':        'One smaller add-on each month (a new tool for one job) — ahead of Standard',
      'services.pri_f10':       'One larger add-on every 6 months (a whole new part of the product)',
      'services.pri_f11':       'Unused hours carry over 30 days',
      'services.pri_f12':       'Hosting, updates, monitoring \u00b7 website, iPhone, and Android',
      'services.maint_cta':     'Discuss Plan',
      'services.maint_policy':  'Your first included month is the plan you pick. Custom work beyond the add-on cadence is quoted separately. We reply on the clock; the repair uses leftover hours. Weekdays 10am\u20136pm Pacific. Portal preferred; email and text also count.',
    ...
    es: {
      ...
      'services.web_note':     'Solo sitio \u00b7 Paquete fijo \u00b7 ~1\u20132 semanas \u00b7 Mantenimiento incluido \u00b7 solo 1 mes',
      'services.web_f1':       'Sitio web (1\u20133 p\u00e1ginas) \u2014 inicio, servicios, trabajos y contacto',
      'services.web_f2':       'Formularios de cotizaci\u00f3n y reserva',
      'services.web_f3':       'Galer\u00eda de trabajos con rese\u00f1as y testimonios',
      'services.web_f4':       'Chat en vivo para que los clientes te escriban directamente',
      'services.web_f5':       'Tocar para llamar y tocar para enviar mensaje en cada p\u00e1gina',
      'services.web_f6':       'P\u00e1ginas biling\u00fces para clientes (ingl\u00e9s + espa\u00f1ol)',
      'services.web_f7':       'SEO b\u00e1sico + anal\u00edticas para saber qui\u00e9n visita',
      'services.web_f8':       'Soporte de lanzamiento y configuraci\u00f3n de hospedaje',
      'services.web_f9':       'Link Tree con tu marca para Instagram y TikTok (tu \u00fanico enlace de bio)',
      'services.web_cta':      'Comenzar desde $799',
      ...
      'services.starter_f1':    'Sitio web (1\u20133 p\u00e1ginas) \u2014 los clientes usan el sitio, no una app',
      'services.starter_f2':    'App iOS y Android para ti y el equipo',
      'services.starter_f3':    'Formularios de cotizaci\u00f3n y reserva',
      'services.starter_f4':    'Chat en vivo para que los clientes te escriban directamente',
      'services.starter_f5':    'Galer\u00eda, rese\u00f1as y p\u00e1ginas biling\u00fces (ingl\u00e9s + espa\u00f1ol)',
      'services.starter_f6':    'Alertas cuando alguien consulta',
      'services.starter_f7':    'Soporte de configuraci\u00f3n en App Store y Google Play',
      'services.starter_f8':    'SEO b\u00e1sico + anal\u00edticas, lanzamiento y hospedaje',
      'services.starter_f9':    'Link Tree con tu marca para Instagram y TikTok (tu \u00fanico enlace de bio)',
      ...
      'services.growth_f1':     'Sitio: Inicio, Servicios, Trabajos, Rese\u00f1as, Contacto \u2014 los clientes usan la web',
      'services.growth_f2':     'App iOS y Android para due\u00f1o y equipo (no una app de escaparate para clientes)',
      'services.growth_f3':     'Formularios de cotizaci\u00f3n y reserva, chat en vivo, biling\u00fce ingl\u00e9s / espa\u00f1ol',
      'services.growth_f4':     'Pagos Stripe con propinas, impuestos y facturaci\u00f3n recurrente',
      'services.growth_f5':     'Admin para leads, trabajos, calendario, clientes y bandeja',
      'services.growth_f6':     'Cotizaciones y facturas en PDF enviadas al cliente',
      'services.growth_f7':     'Asignaci\u00f3n de equipo, horarios y horas por trabajo',
      'services.growth_f8':     'Portafolio antes/despu\u00e9s \u2014 el equipo sube, t\u00fa apruebas, se publica en el sitio',
      'services.growth_f9':     'Notificaciones push y correo, recordatorios de pago y citas',
      'services.growth_f10':    'Tap to Pay en iPhone para trabajos en campo',
      'services.growth_f11':    'Lanzamiento, hospedaje, App Store y Google Play',
      ...
      'services.ess_f1':        '2 horas al mes \u00b7 1 sesi\u00f3n de trabajo',
      'services.ess_f2':        'Respondemos en 5 d\u00edas h\u00e1biles',
      'services.ess_f3':        'Revisamos errores y flujos rotos (despu\u00e9s de Est\u00e1ndar y Prioritario)',
      'services.ess_f4':        'Si el sitio o la app se cae, te escribimos en 1 d\u00eda h\u00e1bil (d\u00edas de semana)',
      'services.ess_f5':        'Actualizaciones a Apple y Google 4 veces al a\u00f1o, en tu sesi\u00f3n de trabajo',
      'services.ess_f6':        'Actualizaciones de contenido y textos en tu sesi\u00f3n de trabajo',
      'services.ess_f7':        'Funciones y extras nuevos se cotizan aparte',
      'services.ess_f8':        'Hospedaje, actualizaciones, monitoreo \u00b7 sitio, iPhone y Android',
      ...
      'services.std_f1':        '6 horas al mes \u00b7 2 sesiones de trabajo',
      'services.std_f2':        'Respondemos en 3 d\u00edas h\u00e1biles',
      'services.std_f3':        'Revisamos errores y flujos rotos — antes que Esencial',
      'services.std_f4':        'Si el sitio o la app se cae, te escribimos en 4 horas',
      'services.std_f5':        'Noches y fines de semana incluidos si el sitio o la app se cae',
      'services.std_f6':        'Actualizaciones a Apple y Google cada mes, ambas tiendas',
      'services.std_f7':        'Contenido mensual (fotos, precios, horarios, textos) — aparte de las sesiones de trabajo',
      'services.std_f8':        'Una funci\u00f3n nueva peque\u00f1a cada mes (usa tus horas)',
      'services.std_f9':        'Un extra m\u00e1s chico cada trimestre (una herramienta para un trabajo)',
      'services.std_f10':       'Un extra m\u00e1s grande cada a\u00f1o (una parte nueva del producto)',
      'services.std_f11':       'Hospedaje, actualizaciones, monitoreo \u00b7 sitio, iPhone y Android',
      ...
      'services.pri_f1':        '10 horas al mes \u00b7 3 sesiones de trabajo',
      'services.pri_f2':        'Respondemos en 1 d\u00eda h\u00e1bil',
      'services.pri_f3':        'Revisamos errores y flujos rotos — antes que Est\u00e1ndar',
      'services.pri_f4':        'Si el sitio o la app se cae, te escribimos en 2 horas',
      'services.pri_f5':        'Noches y fines de semana incluidos si el sitio o la app se cae — antes que Est\u00e1ndar',
      'services.pri_f6':        'Actualizaciones a Apple y Google cuando las necesites, ambas tiendas',
      'services.pri_f7':        'Contenido semanal (fotos, precios, horarios, textos) — aparte de las sesiones de trabajo',
      'services.pri_f8':        'Funciones nuevas peque\u00f1as en tus horas, seg\u00fan quepan',
      'services.pri_f9':        'Un extra m\u00e1s chico cada mes (una herramienta para un trabajo) — antes que Est\u00e1ndar',
      'services.pri_f10':       'Un extra m\u00e1s grande cada 6 meses (una parte nueva del producto)',
      'services.pri_f11':       'Las horas no usadas pasan 30 d\u00edas',
      'services.pri_f12':       'Hospedaje, actualizaciones, monitoreo \u00b7 sitio, iPhone y Android',
      'services.maint_cta':     'Hablar sobre el Plan',
      'services.maint_policy':  'Tu primer mes incluido es el plan que elijas. El trabajo a la medida fuera del ritmo de extras se cotiza aparte. Respondemos en el reloj; la reparaci\u00f3n usa las horas que queden. D\u00edas de semana 10am\u20136pm Pac\u00edfico. Portal de preferencia; correo y texto tambi\u00e9n cuentan.',
