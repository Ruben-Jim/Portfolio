...
(function () {
  ...
  var CWR_I18N = {
    en: {
      ...
      'services.starter_sub':   'Website + iOS &amp; Android app — a 1\u20133 page site or starter storefront plus a branded phone app so customers can find you and inquire from either place.',
      'services.starter_note':  'Website + App \u00b7 Fixed package \u00b7 ~2\u20133 weeks \u00b7 Maintenance included \u00b7 1 month only',
      'services.starter_f1':    'Branded website (1\u20133 pages) + iOS &amp; Android app',
      'services.starter_f2':    'Quote request + booking request forms on web and in-app',
      ...
      'services.starter_f6':    'Push or in-app alerts when someone inquires',
      'services.starter_f7':    'App Store &amp; Google Play setup support',
      'services.starter_f8':    'Basic SEO + analytics so you know who visits',
      'services.starter_f9':    'Launch + hosting setup support',
      'services.starter_f10':   'Branded Link Tree for Instagram &amp; TikTok (your one bio link)',
      'services.starter_cta':   'Start at $1,500',

      'services.growth_badge':  'Most Popular',
      'services.growth_title':  'Growth Platform',
      'services.growth_sub':    'Website + iOS &amp; Android app plus an admin so leads and bookings land in one place — not scattered texts and DMs.',
      'services.growth_note':   'Website + App \u00b7 Fixed package \u00b7 3\u20134 weeks \u00b7 Maintenance included \u00b7 1 month only',
      'services.growth_f1':     'Website (up to 5 pages) + iOS &amp; Android app',
      ...
      'services.growth_f12':    'Branded Link Tree for Instagram &amp; TikTok (your one bio link)',
      ...
      'services.biz_inv_note':  'Website + App \u00b7 Scoped after discovery \u00b7 1 month maintenance included',
      ...
      'services.studio_inv_note': 'Website + App \u00b7 Custom scope \u00b7 Timeline after discovery \u00b7 1 month maintenance included',
      ...
      'services.ess_sub':       'Keep hosting, updates, and monitoring healthy between busy seasons — slower response, same web + mobile coverage.',
      'services.ess_mo_note':   '5 business days \u00b7 1 maintenance window/month',
      ...
      'services.ess_f1':        'Response within 5 business days',
      'services.ess_f2':        '1 maintenance window per month',
      'services.ess_f3':        'Hosting, updates, monitoring, minor fixes',
      'services.ess_f4':        'Web + iOS + Android support',

      'services.std_title':     'Standard Care',
      'services.std_sub':       'Recommended for live day-to-day ops — faster response than Essential, plus live-ops triage and small content tweaks in your monthly window (web, iOS &amp; Android).',
      ...
      'services.std_f4':        'Live-ops triage for bugs &amp; broken flows',
      'services.std_f5':        'Small content &amp; copy tweaks in your window',
      'services.std_f6':        'Web + iOS + Android support',

      'services.pri_title':     'Priority Care',
      'services.pri_sub':       'Same coverage as Standard with faster response and more maintenance windows for high-volume teams.',
    ...
    es: {
      ...
      'services.starter_sub':   'Sitio web + app iOS y Android — de 1 a 3 p\u00e1ginas m\u00e1s una app con tu marca para que los clientes te encuentren y consulten desde cualquiera de los dos.',
      'services.starter_note':  'Sitio + App \u00b7 Paquete fijo \u00b7 ~2\u20133 semanas \u00b7 Mantenimiento incluido \u00b7 solo 1 mes',
      'services.starter_f1':    'Sitio web (1\u20133 p\u00e1ginas) + app iOS y Android',
      'services.starter_f2':    'Formularios de cotizaci\u00f3n y reserva en web y en la app',
      ...
      'services.starter_f6':    'Alertas push o en la app cuando alguien consulta',
      'services.starter_f7':    'Soporte de configuraci\u00f3n en App Store y Google Play',
      ...
      'services.starter_f10':   'Link Tree con tu marca para Instagram y TikTok (tu \u00fanico enlace de bio)',
      ...
      'services.growth_sub':    'Sitio web + app iOS y Android m\u00e1s un panel para que leads y reservas lleguen a un solo lugar \u2014 no en mensajes dispersos.',
      'services.growth_note':   'Sitio + App \u00b7 Paquete fijo \u00b7 3\u20134 semanas \u00b7 Mantenimiento incluido \u00b7 solo 1 mes',
      'services.growth_f1':     'Sitio web (hasta 5 p\u00e1ginas) + app iOS y Android',
      ...
      'services.growth_f12':    'Link Tree con tu marca para Instagram y TikTok (tu \u00fanico enlace de bio)',
      ...
      'services.biz_inv_note':  'Sitio + App \u00b7 Definido tras descubrimiento \u00b7 1 mes de mantenimiento incluido',
      ...
      'services.studio_inv_note': 'Sitio + App \u00b7 Alcance personalizado \u00b7 Tiempo tras descubrimiento \u00b7 1 mes de mantenimiento incluido',
      ...
      'services.ess_sub':       'Mant\u00e9n el hospedaje, las actualizaciones y el monitoreo saludables entre temporadas — respuesta m\u00e1s lenta, misma cobertura web + m\u00f3vil.',
      'services.ess_mo_note':   '5 d\u00edas h\u00e1biles \u00b7 1 ventana de mantenimiento/mes',
      ...
      'services.ess_f1':        'Respuesta en 5 d\u00edas h\u00e1biles',
      'services.ess_f2':        '1 ventana de mantenimiento al mes',
      'services.ess_f3':        'Hospedaje, actualizaciones, monitoreo, correcciones menores',
      'services.ess_f4':        'Soporte Web + iOS + Android',

      'services.std_title':     'Cuidado Est\u00e1ndar',
      'services.std_sub':       'Recomendado para operaciones del d\u00eda a d\u00eda — respuesta m\u00e1s r\u00e1pida que Esencial, m\u00e1s triaje en vivo y ajustes peque\u00f1os de contenido en tu ventana mensual (web, iOS y Android).',
      ...
      'services.std_f4':        'Triaje en vivo para bugs y flujos rotos',
      'services.std_f5':        'Ajustes peque\u00f1os de contenido y texto en tu ventana',
      'services.std_f6':        'Soporte Web + iOS + Android',

      'services.pri_title':     'Cuidado Prioritario',
      'services.pri_sub':       'La misma cobertura que Est\u00e1ndar con respuesta m\u00e1s r\u00e1pida y m\u00e1s ventanas de mantenimiento para equipos de alto volumen.',
